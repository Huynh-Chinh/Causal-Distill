...
class RobertaOnlyMLMHead(nn.Module):
    ...
    def forward(self, sequence_output):
        prediction_scores = self.predictions.forward(sequence_output)
...
class RobertaModel(RobertaPreTrainedModel):
    ...
    def forward(
        ...
        pooled_output = self.pooler.forward(sequence_output) if self.pooler is not None else None
...
class RobertaForPreTraining(RobertaPreTrainedModel):
    ...
    def forward(
        ...
        prediction_scores, seq_relationship_score = self.cls.forward(sequence_output, pooled_output)
